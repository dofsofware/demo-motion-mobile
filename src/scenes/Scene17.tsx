...
export const Scene17 = ({ inFrame, outFrame, crossfadeFrames }: P) => {
  ...
  const cardRise = (delaySec: number) => {
    ...
    if (frame < start) return { opacity: 0, translateY: 60, blur: 6 };
  ...
  const card1 = cardRise(0.2);
  const card2 = cardRise(0.5);
  const card3 = cardRise(0.8);
  const card4 = cardRise(1.1);

  // Pulse green animation on the status dot (1.2s cycle)
  const dotGreenPulse = pulseValue(time, 1.2);
  const dotGreenShadow = interpolate(dotGreenPulse, [-1, 1], [0, 12]);
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Alertes instantanées, suivi de dossiers
              </div>
              <div
                style={{
                  fontSize: 24,
              ...
              >
                <span
                  style={{
                    ...
                    background: "#22C55E",
                    borderRadius: "50%",
                    boxShadow: `0 0 0 ${dotGreenShadow}px rgba(34,197,94,0.5)`,
                  }}
                />
                Connecté
              </div>
            ...
            >
              ...
              >
                Alertes temps réel, rappels d'échéance
              </div>
              <div
                style={{
                  fontSize: 24,
            ...
            <div
              style={{
                ...
                transform: `translateY(${card3.translateY}px)`,
            ...
            >
              ...
              >
                Alertes critiques, suivi sans smartphone
              </div>
              <div
                style={{
                  fontSize: 24,
            ...
            <div
              style={{
                ...
                transform: `translateY(${card4.translateY}px)`,
            ...
            >
              ...
              >
                Rapports détaillés, pièces jointes
              </div>
              <div
                style={{
                  fontSize: 24,
