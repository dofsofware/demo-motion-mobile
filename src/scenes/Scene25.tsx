...
export const Scene25 = ({ inFrame, outFrame, crossfadeFrames }: P) => {
  ...
  const qualityPop = (delaySec: number, durationSec: number) => {
    ...
    const translateY = interpolate(progress, [0, 0.6, 1], [40, -8, 0], clamp);
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 28, color: "#2C3E66", textAlign: "center" }}>
              Quelques clics
            </div>
          </div>
